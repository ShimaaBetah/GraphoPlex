...
import com.server.graph_db.traversers.runnables.FilterIncomingEdgesRunnable;
import com.server.graph_db.traversers.runnables.FilterOutGoingEdgesRunnable;
import com.server.graph_db.traversers.runnables.FilterVerticesRunnable;
import com.server.graph_db.traversers.runnables.GetVerticesRunnable;
...
public class GlobalTraverserManager {
    ...
    public Iterable<EdgeId> filterOutgoingEdges (Iterable<String> verticesIds, EdgeBinding edgeBinding ) throws Exception{
        System.out.println("into filterOutgoingEdges");
        System.out.println("verticesIds: " + verticesIds);
