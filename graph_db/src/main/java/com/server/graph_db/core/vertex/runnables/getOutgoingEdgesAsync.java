...
public class getOutgoingEdgesAsync implements Runnable {
    ...
    public getOutgoingEdgesAsync(LocalVertexService vertexService, Iterable<String> verticesIds, String serverId,
    ...
    public void run() {
        if (partitionId == Integer.parseInt(serverId)) {
            ...
            try {
                edgesFromMyServer = vertexService.getOutgoingEdges(verticesIds);
            ...
            Iterable<Edge> edgesFromOtherServer = vertexClient.getOutgoingEdges(verticesIds,
